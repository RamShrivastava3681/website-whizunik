...
const LifecycleSection = () => {
  return (
    <section className="py-32 bg-on-secondary-fixed text-primary-foreground overflow-hidden">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="relative">
          <div className="hidden md:block absolute top-12 left-0 w-full h-px bg-primary-foreground/20"></div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {steps.map((step) => (
              <div key={step.num} className="relative z-10">
                <div className="w-12 h-12 bg-primary rounded-[2rem] flex items-center justify-center mb-8">
